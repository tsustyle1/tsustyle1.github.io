...
title: Remote
date: 2020-12-24
excerpt: "'Remote' is an Easy rated box on Hack The Box. We'll gain credentials for the Umbraco CMS by mounting the site backup share, and using those creds we will gain RCE using a public exploit. We'll craft a shell using msfvenom from Metasploit and exploit a vulnerable version of Teamviewer to gain administrator access"
tags:
  - htb
  - umbraco
  - metasploit
