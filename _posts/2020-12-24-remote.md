...
![nmap](/assets/images/remote/header.png)
...
![nmap](/assets/images/remote/nmap.png)

Interesting. FTP, Webserver and maybe some nfs shares we can mount?

Let's take a look at the site

![nmap](/assets/images/remote/site1.png)

Looks like some sort of blog.. 'Umbraco'?

![nmap](/assets/images/remote/site2.png)

![nmap](/assets/images/remote/login.png)
...
![nmap](/assets/images/remote/showmount.png)
...
![nmap](/assets/images/remote/rce.png)
...
![nmap](/assets/images/remote/listener.png)
...
![nmap](/assets/images/remote/peasupload.png)

![nmap](/assets/images/remote/peas.png)
...
![nmap](/assets/images/remote/teamviewersearch.png)

![nmap](/assets/images/remote/teamviewerpassword.png)

Could that be the **Admin** password? Let's check using [evil-winrm](https://github.com/Hackplayers/evil-winrm)

![nmap](/assets/images/remote/admin.png)

![nmap](/assets/images/remote/userflag.png)

![nmap](/assets/images/remote/rootflag.png)
